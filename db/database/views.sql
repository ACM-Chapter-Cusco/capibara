...
CREATE OR REPLACE VIEW circles_active AS SELECT * FROM circles WHERE active = TRUE;
CREATE OR REPLACE VIEW circle_members_active AS SELECT * FROM circle_members WHERE active = TRUE;
